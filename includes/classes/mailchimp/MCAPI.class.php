...
if( !class_exists('MCAPI') ){
    class MCAPI
    {
        ...
        {
            $message .= '<br /><br />' . sprintf( '<a href="%s">' . __( 'Read more about common connectivity issues.', 'worldmart-toolkit' ) . '</a>', 'https://kb.mc4wp.com/solving-connectivity-issues/#utm_source=wp-plugin&utm_medium=mailchimp-for-wp&utm_campaign=settings-notice' );
        ...
        private function get_headers()
        {
            ...
            $headers = array(
                ...
                'User-Agent' => 'OVIC/1.0.0; WordPress/' . $wp_version . '; ' . get_bloginfo( 'url' ),
            );
